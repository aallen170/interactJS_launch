...
function mouseDragElement(elmnt) {
  ...
  function dragMouseDown(e) {
    ...
    elmnt.ontouchend = closeDragElement; // call a function whenever the cursor moves:
  ...
  function elementDrag(e) {
    ...
    if (e.ctrlKey) {// test resizing functionality
    } else {
  ...
  function closeDragElement() {
    console.log("closing drag"); // stop moving when mouse button is released:
